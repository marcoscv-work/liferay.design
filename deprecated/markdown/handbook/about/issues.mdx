...
We use [GitHub's Projects feature](https://github.com/liferay-design/design.liferay.com/projects/8) to manage all things related with the Handbook.

_If you haven't already, please see [our GitHub guide](/handbook/tools/github)._

## Create an Issue

1. Create a [Handbook issue](https://github.com/liferay-design/design.liferay.com/issues/new?template=handbook_request.md)
...
If the issue is potentially sensitive, you can start a thread on the corresponding [#t-design-github](https://liferay.slack.com/archives/CMLT0TBH7) post when you first created the issue.
...
You can request on the issue thread in [#t-design-github](https://liferay.slack.com/archives/CMLT0TBH7), or post directly in the issue.

### Pull-Requests

Please follow the [pull request guidelines](/handbook/about/pull-requests).

...
In a status message modal, [action-based color buttons](https://design.liferay.com/lexicon/core-components/buttons/action-buttons/) can be used to draw attention and 
emphasize the meaning of a message.

![Modal for Status Messages](/images/lexicon/ModalsforStatusMessages.png)

However, if a modal is used as a [confirmation message](https://design.liferay.com/lexicon/core-components/confirm-message/) to prevent the user from a critical situation that can’t be easily undone such as deleting a site, 

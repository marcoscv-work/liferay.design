...
Finally, let me mention that here in Liferay, we love open-source projects and so we’re sharing a copy of our [Lexicon library](https://design.liferay.com/resources/figma/) along with some other resources. You can use the Lexicon library components and the other resources for free, and your feedback is always welcome (including as Figma comments, if you prefer).



-   [Download the ‘Lexicon’ library](https://design.liferay.com/resources/figma/)

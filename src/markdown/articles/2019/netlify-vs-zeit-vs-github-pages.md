...
![Google Lighthouse results for Design.Liferay](/images/articles/netlify-is-pure-speed.png)
_The only thing we changed between these two is the host — Netlify is just flat-out fast. <br />P.S. We're fixing [the accessibility issue](https://github.com/liferay-design/design.liferay.com/milestone/1)_

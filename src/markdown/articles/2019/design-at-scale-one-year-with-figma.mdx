...
By 2017, we had a few designers using it for most of their work, and one of the [Lexicon designers](https://twitter.com/emilianogcicero) ([Liferay’s design system](https://design.liferay.com/lexicon)), Emiliano Cicero, was quickly becoming an evangelist — which turned out to be a key factor in convincing the rest of the team to make the switch.
...
Other utilities that we developed over time were [redline components](https://www.figma.com/file/6GlUEYKNbmobxSgfW2fRQA/design.liferay.com-utilities?node-id=624%3A5566) for making precise handoff specs, [sticky notes](https://www.figma.com/file/6GlUEYKNbmobxSgfW2fRQA/design.liferay.com-utilities?node-id=1071%3A1313) for affinity diagrams (and just about anything), and flow nodes.
...
_Open sourced files from Design.Liferay._

To access any of these files, check out [design.liferay.com/resources/figma](/resources/figma), and stay tuned as we grow and share more!

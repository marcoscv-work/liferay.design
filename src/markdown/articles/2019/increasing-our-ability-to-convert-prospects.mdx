...
**<small style={{ marginBottom: '2em' }}>Implementing a new landing page on liferay.com moved from being a developer task that took up to 3 weeks to be prioritized to an on-demand marketer task with an immediate turnaround and increased landing page functionality.</small>**
...
<Link to="https://style.design.liferay.com">
	<Image
		...
		size="small"
		margin="0 0 6rem 2rem"
		caption="style.design.liferay.com"
	/>
</Link>

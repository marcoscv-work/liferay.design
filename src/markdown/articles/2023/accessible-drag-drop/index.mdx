...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Drag and Drop examples in Liferay products</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Fragment list and available actions</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Fragment positioning by keyboard</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Drag and drop interaction for page building</p>

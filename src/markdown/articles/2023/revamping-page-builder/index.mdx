...
featuredImage: '/images/articles/rev-cover.png'
tags: ['Product']
publish: true
---
...
![Old inputs vs new styles configuration](/styling.png)
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Old inputs vs new styles configuration</p>
...
![Custom CSS box in the fragment configuration tab](/css1.png) 
![Page configuration for Client Extensions](/css2.png)
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Fragments custom CSS and CSS extensions</p>
...
![Fragments ordering](/fragments.png)
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Fragments ordering feature</p>
...
![New two sidepanel layout for page builder](/page-editor.png)
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>New two sidepanel layout for page builder</p>

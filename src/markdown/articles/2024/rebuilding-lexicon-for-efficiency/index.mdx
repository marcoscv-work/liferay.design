...
featuredImage: '/images/articles/1-cover-image.jpg'
tags: ['Product']
publish: true
---

*This article was co-written with [María Arce](https://design.liferay.com/team/arce-maria/).*
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Detach numbers & statistics from the survey</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>New Library Organization</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Slot Incorporation</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Interactive Components - Hover</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Focus State applied to different components</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Modular Structure</p>

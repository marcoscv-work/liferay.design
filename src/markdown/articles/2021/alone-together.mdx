...
featuredImage: '/images/articles/alone-together/feature-image.jpg'
publish: true
---

import { Image, Link } from 'components/atoms'
import { Embed, Heading } from 'theme-ui'
...
<Heading sx={{ variant: 'quotes.blockQuote' }}>
	...I was amazed.
</Heading>
...
<Link
	to="https://marcocuel.com/p/starbucks/"
	sx={{
		textAlign: 'center',
		color: 'mainL4',
		fontStyle: 'italic',
...
>MarcoCuel.com/p/starbucks</Link>

...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Hierarchy - Documents and Media Liferay DXP</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Hierarchy - Content Performance Liferay DXP</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Emphasis - Raylife Initializer Liferay DXP</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>White Space - Forms Liferay DXP</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Dense UI - Commerce Liferay</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>White spacing - Forms Rule Liferay DXP</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Columns - System Settings Liferay DXP</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Fluid design - Sidepanel Liferay DXP</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Color - Alert Liferay DXP</p>


![Forms Summary - Liferay DXP](/12-color.png)
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Color - Forms Summary Liferay DXP</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>The color and type choices of the first example exudes modern elegance and technological advancement.</p>


![Masterclass Initializer- Liferay Commerce](/14-personality-masterclass.png)
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>The rounded edges, color and type pairing makes this design lighthearted.</p>
...
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Empty State - Segments Liferay DXP</p>


![Forms - Liferay DXP](/16-empty-state.png)
<p style={{ textAlign: 'center', fontSize: '1rem', fontStyle: 'italic', color: '#6b6c7e', marginBottom: '2rem' }}>Empty State - Forms Liferay DXP</p>

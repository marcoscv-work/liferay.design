...
You do this by navigating to [the repo in GitHub](http://github.com/liferay-design/design.liferay.com) and clicking the “Fork” button, currently at the top right-hand corner of a repo. This will be the “origin” — your fork on your GitHub account.

As an example, navigating to [https://github.com/yourGitHubUsername/design.liferay.com](https://github.com/yourGitHubUsername/design.liferay.com) should show your fork of the Design.Liferay repo.

![A screenshot showing GitHub user victorvalle’s fork of the Design.Liferay repo.](/images/articles/should-designers-code/part-2/user-victorvalle-s-fork.png)
...
Navigate into the `/project` folder. In this case, we’ll enter `cd design.liferay.com`. Most projects will include a _README.md_ file in the `/root` folder, this is typically the starting place for installing and running the project. For our purposes, to install, enter `npm install`. Once it’s installed, enter `npm run dev`.
...
To track the upstream remote, in your terminal enter the following:
    ...
    git remote add upstream https://github.com/liferay-design/design.liferay.com
...
_`origin` and `upstream` are the most common labels for remotes — origin is your fork, upstream is the source._
    ...
    origin   https://github.com/yourGitHubUsername/design.liferay.com (fetch)
    origin    https://github.com/yourGitHubUsername/design.liferay.com (push)
    upstream  https://github.com/liferay-design/design.liferay.com (fetch)
    upstream  https://github.com/liferay-design/design.liferay.com (push)

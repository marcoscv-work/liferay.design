...
import { Flex, Image, Text, Link, Heading } from 'components/atoms'
...
He showed the new updates in our [library](https://www.figma.com/community/file/961581638760900307) to improve our design and development teams’ use of our components, the new internal [documentation](https://design.liferay.com/lexicon) linked to each component and usage guides to help teams to familiarize themselves with the use of design libraries.

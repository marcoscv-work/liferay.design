...
We definitely appreciate contributions in any form &mdash; QA, [submitting issues](https://github.com/liferay-design/design.liferay.com/issues), providing feedback, code, design, etc.

If you're part of the Liferay team in Figma, there's a Design.Liferay project &mdash; you can see where we're at and contribute comments, designs, etc there.

If you'd like to help manage deployments, please [request to join our Netlify team](mailto:paul.hanaoka@liferay.com?subject=I'd%20like%20to%20join%20the%20Netlify%20team%20for%20Design.Liferay!&body=Pretty%20please!%20%0A%0A%5Badd%20some%20reasons%5D)!

A good place to start is our [Issues page](https://github.com/liferay-design/design.liferay.com/issues)!

## How To:

_If this is your first time using GitHub, see our [initial set up suggestions](/handbook/tools/your-laptop/)._
...
1. All work should be done on a named branch — e.g. 'Issue-302' and pull-request sent to the `master` branch.
...
That's it! In 2-4 minutes, the site will be built, deployed, and all updates will be reflected live on [design.liferay.com](https://design.liferay.com).
...
_See full the full [Contributing](https://github.com/liferay-design/design.liferay.com/blob/master/CONTRIBUTING.md) guidelines for a more exhaustive process._
